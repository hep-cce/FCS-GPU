...
for base_image in ${NVHPC_BASE_IMAGE} ${CUDA_BASE_IMAGE}; do
  ...
  root_image_tag=docker.io/dingpf/root:${ROOT_DOT_VERSION}-${image_tag} # example: dingpf/root:6.30.04-nvhpc23.9-devel-cuda12.2-ubuntu22.04
  ...
  for image_type in fcs-cuda fcs-kokkos-cuda; do
    fcs_image_tag=docker.io/dingpf/${image_type}:${ROOT_DOT_VERSION}-${image_tag} # example: dingpf/fcs-cuda:6.30.04-nvhpc23.9-devel-cuda12.2-ubuntu22.04
