...
public:
  ...
  TFCSExtrapolationState& get_extrapol(int ievent) {
    return m_extrapol[ievent];
  };
  ...
  int add_validation(const char* name, const char* title,
                     TFCSParametrizationBase* sim) {
