...
class TFCSInputValidationPlots : public TFCSAnalyzerBase {
 ...
 public:
  ...
  void PlotTH1Layer(std::string var, int nbins, double xmin, double xmax,
                    std::string);
  void PlotTH1PCA(std::string var, std::string xlabel);
  void PlotTH1PCA(std::string var, int layer, int nbins, double xmin,
                  double xmax, std::string xlabel);

  void PlotTH2(std::string var, std::string xlabel, std::string ylabel);
  void PlotTH2(std::string var, int layer, int pca, int nbinsx, double xmin,
  ...
  void CreateInputValidationHTML(std::string filename,
                                 std::vector<std::string>);

  void PlotJOValidation(std::vector<std::string>* files, std::string var,
                        std::string xlabel);
