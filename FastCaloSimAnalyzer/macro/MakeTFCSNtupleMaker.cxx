...
void MakeTFCSNtupleMaker() {
  ...
  topDir = "/eos/atlas/atlascerngroupdisk/proj-simul/InputSamplesLocalProd2017/rel_21_0_42/Samples/";
#endif

#if defined( __APPLE__ )
  std::cout << "* Running on mac os system " << std::endl;
  topDir = "/Users/ahasib/Documents/Analysis/Data/FCS/InputSamplesLocalProd2017/rel_21_0_40/SpecialSamples/";
#endif

  TString inputSample = topDir + "photon_E50000_eta_20_25.calohit_all_1mm_noParamAlg.root";

  TString pcaSample = topDir + "photon_E50000_eta_20_25.pca_all_1mm_noParamAlg.root";

  TString flatSample = topDir + "photon_E50000_eta_20_25.flatcalohit_all_1mm_noParamAlg.root";
