...
std::string dsid_basedir =
    "/eos/atlas/user/a/ahasib/public/Simul-FastCalo/"
    "ParametrizationProductionVer06/";
std::string input_basedir =
    "/eos/atlas/atlascerngroupdisk/proj-simul/InputSamplesSummer18Complete/";
std::string FirstPCA_App_basedir =
    "/eos/atlas/user/a/ahasib/public/Simul-FastCalo/"
    "ParametrizationProductionVer06/";
std::string param_etaslice_basedir =
    "/eos/atlas/user/a/ahasib/public/Simul-FastCalo/"
    "ParametrizationProductionVer06/";
...
std::string get_dsid_firstPCAname(std::string dsid,
                                  std::string basedir = dsid_basedir,
                                  std::string version = dsid_version);
std::string get_dsid_firstPCA_Appname(std::string dsid,
                                      std::string basedir =
                                          FirstPCA_App_basedir,
