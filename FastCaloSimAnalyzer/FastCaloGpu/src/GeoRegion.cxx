...
inline bool GeoRegion::index_range_adjust( int& ieta, int& iphi ) {
...
inline float GeoRegion::calculate_distance_eta_phi( const long long DDE, float eta, float phi,
...
inline long long GeoRegion::getDDE( float eta, float phi, float* distance, int* steps) {
