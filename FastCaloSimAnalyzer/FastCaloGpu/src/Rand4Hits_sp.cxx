...
void Rand4Hits::allocate_simulation(int /*maxbins*/, int maxhitct,
  ...
  std::cout << "Rand4Hits: Allocate " << n_cells << " x " << MAX_SIM
            << " cells\n";
  ...
  printf(" R4H_sp ncells: %lu  cells_energy: %p  cells_size: %lu hitcells_E: "
         "%p  hitcells_ct: %p\n",
         n_cells, (void *)m_cells_energy, MAX_SIM * n_cells, (void *)m_cell_e,
         (void *)m_ct);
}
