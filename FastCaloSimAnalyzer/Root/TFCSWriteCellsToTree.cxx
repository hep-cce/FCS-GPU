...
TFCSWriteCellsToTree::TFCSWriteCellsToTree(const char* name, const char* title,TTree* tree):TFCSParametrization(name,title)
{
  init_tree(tree);
}
...
FCSReturnCode TFCSWriteCellsToTree::simulate(TFCSSimulationState& simulstate,const TFCSTruthState* /*truth*/, const TFCSExtrapolationState* /*extrapol*/)
{
