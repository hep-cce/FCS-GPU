...
FCSReturnCode TFCSHistoLateralShapeParametrizationFCal::simulate_hit(
  ...
  // const double center_r=0.5*( extrapol->r(cs, CaloSubPos::SUBPOS_ENT) +
  // extrapol->r(cs, CaloSubPos::SUBPOS_EXT) );
  // const double center_z=0.5*( extrapol->z(cs, CaloSubPos::SUBPOS_ENT) +
  // extrapol->z(cs, CaloSubPos::SUBPOS_EXT) );
