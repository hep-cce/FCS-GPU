...
TFCSValidationEnergyAndCells::TFCSValidationEnergyAndCells(const char* name, const char* title,TFCSAnalyzerBase* analysis):TFCSLateralShapeParametrization(name,title),m_analysis(analysis)
{
}

FCSReturnCode TFCSValidationEnergyAndCells::simulate(TFCSSimulationState& simulstate,const TFCSTruthState* /*truth*/, const TFCSExtrapolationState* /*extrapol*/)
{
  ...
  if(is_UseAvgShape()) {
    cellVector=analysis()->avgcellVector();
  }
