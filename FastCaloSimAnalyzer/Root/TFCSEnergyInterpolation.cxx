...
TFCSEnergyInterpolation::TFCSEnergyInterpolation(const char* name,
                                                 const char* title)
    : TFCSParametrization(name, title), m_slope(1), m_offset(0) {}

FCSReturnCode TFCSEnergyInterpolation::simulate(TFCSSimulationState& simulstate,
...
void TFCSEnergyInterpolation::unit_test(
  ...
  TFCSEnergyInterpolation test("testTFCSEnergyInterpolation",
                               "test TFCSEnergyInterpolation");
  test.set_pdgid(22);
