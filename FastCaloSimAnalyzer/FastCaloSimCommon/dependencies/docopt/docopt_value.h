...
namespace docopt {
  inline value::value( bool v ) : kind_( Kind::Bool ) { variant_.boolValue = v; }

  inline value::value( long v ) : kind_( Kind::Long ) { variant_.longValue = v; }

  inline value::value( std::string v ) : kind_( Kind::String ) {
    new ( &variant_.strValue ) std::string( std::move( v ) );
  }

  inline value::value( std::vector<std::string> v ) : kind_( Kind::StringList ) {
    new ( &variant_.strList ) std::vector<std::string>( std::move( v ) );
  }

  inline value::value( value const& other ) : kind_( other.kind_ ) {
    switch ( kind_ ) {
    case Kind::String:
  ...
  inline value::value( value&& other ) noexcept : kind_( other.kind_ ) {
    switch ( kind_ ) {
    case Kind::String:
  ...
  inline size_t value::hash() const noexcept {
    ...
    case Kind::StringList: {
      ...
      for ( auto const& str : variant_.strList ) { hash_combine( seed, str ); }
      return seed;
    }
