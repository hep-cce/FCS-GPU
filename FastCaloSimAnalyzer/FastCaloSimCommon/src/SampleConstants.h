...
namespace FCS {
  ...
  static const std::string BASEDIR_PARAMETRIZATION = path_simul + "/BigParamFiles/";
  static const std::string BASEDIR_GEOMETRY        = path_simul + "/CaloGeometry/";
  static const std::string BASEDIR_DSID            = path_ahasib + "/ParametrizationProduction07/";
  static const std::string BASEDIR_INPUTS          = path_simul + "/InputSamplesProdsysProduction/";
  static const std::string BASEDIR_FIRSTPCA        = path_ahasib + "/ParametrizationProduction07/";
  static const std::string BASEDIR_ETASLICE        = path_ahasib + "/ParametrizationProduction07/";
  static const std::string BASEDIR_WIGGLE          = path_ahasib + "/ParametrizationProduction07/";
  static const std::string BASEDIR_INTERPOLATION   = path_ahasib_legacy + "/ParametrizationProductionVer06/";
