...
void initTFCSAnalyzer(std::string PATH = "../../../../", std::string EnergyParameterizationPath = "../../../../EnergyParametrization", std::string FastCaloSimAnalyzerPath = "../../../../FastCaloSimAnalyzer")
{
  ...
  gInterpreter->AddIncludePath((FastCaloSimAnalyzerPath + "/CLHEP/").c_str());
  gInterpreter->AddIncludePath((FastCaloSimAnalyzerPath + "/HepPDT/").c_str());
  gInterpreter->AddIncludePath((FastCaloSimAnalyzerPath + "/Root/").c_str());
  ...
  gROOT->LoadMacro((FastCaloSimAnalyzerPath + "/atlasstyle/AtlasStyle.C+").c_str());
  gROOT->LoadMacro((FastCaloSimAnalyzerPath + "/atlasstyle/AtlasLabels.C+").c_str());
  gROOT->LoadMacro((FastCaloSimAnalyzerPath + "/atlasstyle/AtlasUtils.C+").c_str());

  gROOT->LoadMacro((FastCaloSimAnalyzerPath + "/HepPDT/Root/ParticleID.cc+").c_str());

  gROOT->LoadMacro((FastCaloSimAnalyzerPath + "/CLHEP/Random/RandomEngine.cxx+").c_str());
  gROOT->LoadMacro((FastCaloSimAnalyzerPath + "/CLHEP/Random/TRandomEngine.cxx+").c_str());
  gROOT->LoadMacro((FastCaloSimAnalyzerPath + "/CLHEP/Random/RandFlat.cxx+").c_str());
  gROOT->LoadMacro((FastCaloSimAnalyzerPath + "/CLHEP/Random/RandGauss.cxx+").c_str());
  gROOT->LoadMacro((FastCaloSimAnalyzerPath + "/CLHEP/Random/RandPoisson.cxx+").c_str());
