...
TGraphAsymmErrors* myMakeBand(TGraphErrors* g0, TGraphErrors* g1,
                              TGraphErrors* g2);
...
void myBoxText(Double_t x, Double_t y, Double_t boxsize, Int_t mcolor,
               const char* text);

void myMarkerText(Double_t x, Double_t y, Int_t color, Int_t mstyle,
                  const char* text, Float_t msize = 2.);
