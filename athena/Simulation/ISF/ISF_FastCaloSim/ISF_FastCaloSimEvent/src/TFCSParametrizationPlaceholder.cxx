...
FCSReturnCode TFCSParametrizationPlaceholder::simulate(
  ...
  ATH_MSG_ERROR(
      "TFCSParametrizationPlaceholder::simulate(). This is a placeholder and "
      "should never get called. Likely a problem in the reading of the "
      "parametrization file occured and this class was not replaced with the "
