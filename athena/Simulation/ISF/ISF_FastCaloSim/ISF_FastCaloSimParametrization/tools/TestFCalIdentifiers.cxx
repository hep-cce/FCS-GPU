  ...
  for (Int_t ientry = 0; ientry < nEvt; ientry++) {
    ...
    for (UInt_t j = 0; j < (*vec).size(); j++) {
      ...
      for (unsigned int ihit = 0;
        ...
        // cout << "Hit position: " << "x: " << x << " y: " << y << " eta: " <<
        // hitVec->Eta() << " phi: " << hitVec->Phi() <<  endl;
        ...
        if (foundCell) {  // && cell){
          ...
          // cout << abs(foundCell->x() - x) << " " << abs(foundCell->y() - y)
          // << endl;
          if (z > 0)
            ...
            cout << "Side C " << hex << foundCell->identify() << " " << cell_ID
                 ...
                 << endl;
          // cout << cell_ID << " " <<
          // ((FCS_matchedcell)(*vec)[j]).hit[ihit].identifier << " " <<
          // ((FCS_matchedcell)(*vec)[j]).hit[ihit].cell_identifier << " " <<
