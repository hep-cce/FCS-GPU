...
StatusCode FastCaloSimGeometryHelper::initialize() {
  ...
  std::cout << "CHECK123 in the FastCaloSimGeometryHelper initialize "
            << std::endl;
  ...
  if (m_geoModel->geoInitialized()) {
    ...
    if (detStore()
            ->regFcn(&IGeoModelSvc::geoInit, m_geoModel,
                     &FastCaloSimGeometryHelper::geoInit, this)
            .isFailure()) {
